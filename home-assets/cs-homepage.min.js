...
/***/ "./src/js/analytics-shim.js":
/*!**********************************!*\
  !*** ./src/js/analytics-shim.js ***!
  \**********************************/
/*! exports provided: default, NoopBackend, GtagBackend */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Analytics; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NoopBackend", function() { return NoopBackend; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "GtagBackend", function() { return GtagBackend; });
/* harmony import */ var debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! debug */ "./node_modules/debug/src/browser.js");
/* harmony import */ var debug__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(debug__WEBPACK_IMPORTED_MODULE_0__);


const debug = debug__WEBPACK_IMPORTED_MODULE_0___default()('analytics')
...
/*!**************************************!*\
  !*** ./src/js/dynamic-navigation.js ***!
  \**************************************/
/*! exports provided: DynamicNavDispatcher */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DynamicNavDispatcher", function() { return DynamicNavDispatcher; });
/* harmony import */ var debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! debug */ "./node_modules/debug/src/browser.js");
/* harmony import */ var debug__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(debug__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _normalize_href__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./normalize-href */ "./src/js/normalize-href.js");
/* harmony import */ var _layout_transition__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./layout-transition */ "./src/js/layout-transition.js");




const debug = debug__WEBPACK_IMPORTED_MODULE_0___default()('dynamic-navigation')
...
class DynamicNavDispatcher {
    constructor({ analytics, contentTriggers }) {
        ...
        this.cache[Object(_normalize_href__WEBPACK_IMPORTED_MODULE_1__["getDomainRelativeUrl"])(location.href)] =
    ...
    _handleClick(evt) {
        ...
        if (Object(_normalize_href__WEBPACK_IMPORTED_MODULE_1__["isCurrentLocation"])(anchor.href) ||
                Object(_normalize_href__WEBPACK_IMPORTED_MODULE_1__["isHashChange"])(anchor.href) ||
                !Object(_normalize_href__WEBPACK_IMPORTED_MODULE_1__["isRelativeHref"])(anchor.href) ||
                hasModifierKey(evt))
            return
    ...
    _handlePopState() {
        const hashChange = Object(_normalize_href__WEBPACK_IMPORTED_MODULE_1__["isHashChange"])(this._lastHref)
    ...
    _handleNavigation(href, options) {
        const relative = Object(_normalize_href__WEBPACK_IMPORTED_MODULE_1__["getDomainRelativeUrl"])(href)
        if (!relative)
...
class PageTransformer {
    ...
    receivedContent(href, content, navigationOptions) {
        ...
        Object(_layout_transition__WEBPACK_IMPORTED_MODULE_2__["transitionContent"])({
    ...
    _updateNavLinks({ active }) {
        ...
        for (let i = 0; i < len; i++) {
            ...
            if (Object(_normalize_href__WEBPACK_IMPORTED_MODULE_1__["getDomainRelativeUrl"])(elem.href) === active) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return initializeMediaEmbeds; });
/**
 * Video elements only autoplay if present on initial page load; cause videos
 * to autoplay after dynamic navigation as well.
 */
function initializeMediaEmbeds(content) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return initializeTwitterEmbeds; });
/* harmony import */ var debug__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! debug */ "./node_modules/debug/src/browser.js");
/* harmony import */ var debug__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(debug__WEBPACK_IMPORTED_MODULE_0__);
...
const debug = debug__WEBPACK_IMPORTED_MODULE_0___default()('embeds:twitter')
 ...
 */
function initializeTwitterEmbeds(content) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scss_cs_homepage_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../scss/cs-homepage.scss */ "./src/scss/cs-homepage.scss");
/* harmony import */ var _scss_cs_homepage_scss__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_scss_cs_homepage_scss__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _dynamic_navigation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./dynamic-navigation */ "./src/js/dynamic-navigation.js");
/* harmony import */ var _analytics_shim__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./analytics-shim */ "./src/js/analytics-shim.js");
/* harmony import */ var _embeds_twitter__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./embeds/twitter */ "./src/js/embeds/twitter.js");
/* harmony import */ var _embeds_media__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./embeds/media */ "./src/js/embeds/media.js");
...
window.__nav = new _dynamic_navigation__WEBPACK_IMPORTED_MODULE_1__["DynamicNavDispatcher"]({
    analytics: new _analytics_shim__WEBPACK_IMPORTED_MODULE_2__["default"]({
        backend: _analytics_shim__WEBPACK_IMPORTED_MODULE_2__["GtagBackend"],
    }),
    contentTriggers: [
        _embeds_twitter__WEBPACK_IMPORTED_MODULE_3__["default"],
        _embeds_media__WEBPACK_IMPORTED_MODULE_4__["default"],
    ],
})
...
/***/ "./src/js/layout-transition.js":
/*!*************************************!*\
  !*** ./src/js/layout-transition.js ***!
  \*************************************/
/*! exports provided: transitionContent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "transitionContent", function() { return transitionContent; });
...
function transitionContent({
    ...
    const tl = animejs__WEBPACK_IMPORTED_MODULE_0__["default"].timeline()
    ...
    if (changingLongform) {
        ...
        if (!newAttrs.isLongform) {
            ...
            animejs__WEBPACK_IMPORTED_MODULE_0__["default"].set(body, { translateX: bodyOffset })
        }
...
/*!**********************************!*\
  !*** ./src/js/normalize-href.js ***!
  \**********************************/
/*! exports provided: getDomainRelativeUrl, isHashChange, isRelativeHref, isCurrentLocation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDomainRelativeUrl", function() { return getDomainRelativeUrl; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isHashChange", function() { return isHashChange; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isRelativeHref", function() { return isRelativeHref; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isCurrentLocation", function() { return isCurrentLocation; });
 ...
 */
function getDomainRelativeUrl(href, { hash = false } = {}) {
